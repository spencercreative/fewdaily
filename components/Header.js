...
import { FiTag, FiInstagram, FiFacebook, FiTwitter, FiYoutube, FiLinkedin, FiMic, FiCornerUpLeft } from "react-icons/fi"
    ...
    return (
        <header role="banner" className={'flex w-full px-wrap items-center py-2 font-black print:hidden' + ' bg-' + day} style={{minHeight: '58px'}}>
            ...
            {router.pathname === '/tags' ? (
                ...
                <>
                <Link href="/tags">
                    <a className="flex items-center leading-none text-lg font-bold" title="Tags">
