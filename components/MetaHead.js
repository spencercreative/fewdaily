...
function HeadMetadata(props) {
    ...
    return (
        <Head>
            ...
            {props.day !== undefined ?
            <>
            <meta property="og:image" content={hostname + '/social-cards/' + props.day + '.png'} />
            <meta property="og:image:secure_url" content={hostname + '/social-cards/' + props.day + '.png'} />
            <meta name="twitter:image" content={hostname + '/social-cards/' + props.day + '.png'} />
            <link rel="apple-touch-icon" sizes="180x180" href={'/favicons/' + props.day + '/apple-touch-icon.png'}/>
            <link rel="icon" type="image/png" sizes="32x32" href={'/favicons/' + props.day + '/favicon-32x32.png'}/>
            <link rel="icon" type="image/png" sizes="16x16" href={'/favicons/' + props.day + '/favicon-16x16.png'}/>
            <link rel="manifest" href={'/favicons/' + props.day + '/site.webmanifest'}/>
            </>
            :
            <>
            <meta property="og:image" content={hostname + '/social-cards/monday.png'} />
            <meta property="og:image:secure_url" content={hostname + '/social-cards/monday.png'} />
            ...
            {props.type !== undefined ? <meta property="og:type" content={props.type} /> : <meta property="og:type" content="website" />}
