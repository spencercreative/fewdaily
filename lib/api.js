...
export function getAllPosts(fields = [], futurePosts = false) {
...
export function getAllTags() {
	...
	const posts = getAllPosts(['title', 'slug', 'excerpt', 'content', 'tags']);
...
export function getAllPostsWithTag(passedTag) {
	var posts = getAllPosts(['title', 'slug', 'excerpt', 'content', 'tags']);
