...
export function sortList(s) {
    ...
    if (typeof window !== "undefined") {
        ...
        var searchQuery = s !== undefined ? s : document.getElementById('list-search').value.toLowerCase()
...
export function zipImages(containerId, pathname) {
    ...
    if (typeof window !== 'undefined') {
        var images = document.getElementById(containerId).querySelectorAll('img')
