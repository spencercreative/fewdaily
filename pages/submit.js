                ...
                {!loading && !success &&
                    <div>
                        ...
                        <label>
                            ...
                            <input type='text' name='link' required placeholder="Twitter Handle" className="rounded-none border-b-0" />
                        </label>
                        <label>
                            <span className="sr-only">Instagram Handle</span>
                            <input type='text' name='link' required placeholder="Instagram Handle" className="rounded-none border-b-0" />
                        </label>
                        <label>
